...
EventInvitationInputFilter = typing.Annotated["EventInvitationInputFilter", strawberry.lazy("src.GraphTypeDefinitions.Domain_Office.EventGQLModel.EventInvitationGQLModel")]
EventInvitationGQLModel = typing.Annotated["EventInvitationGQLModel", strawberry.lazy("src.GraphTypeDefinitions.Domain_Office.EventGQLModel.EventInvitationGQLModel")]
